...
const routeCtx = {
  ...
  // CTO3-10 · wat de geëxtraheerde resellerportaal-routes nodig hebben.
  // Allemaal gehoiste functiedeclaraties of al gedefinieerde modules, dus
  // hier gewoon door te geven zonder getters.
  readBody, actor, assertReseller, resellerChannelActor, resellerPortalAllowed,
  resellerForbidden, foreignResellerParam, armResellerIdempotency, sendResellerError,
  commissionOverview, commissionSvc, resellerDealsSvc, resellerTenantsSvc,
  resellerLicensingSvc, resellerCommissionSvc,
  // increment 5 · Monargo-zijde van het kanaaldomein.
  assertPlatformScope, monargoChannelActor, resellerAuthz, resellerLifecycleSvc,
  payoutDetails, activationToken, isMailLive, resellerPayouts,
};
