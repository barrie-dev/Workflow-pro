...
const REQUIRED_COLLECTIONS = [
  ...
  "resellerCommissionAgreements",
  "resellerCommissionStatements",
  "resellerCommissionDisputes",
  "resellerPayoutChanges",
  "resellerAgreements",
  "resellerLifecycleEvents",
  "resellerReviews",
  "resellerOffboardings",
  "bundles",
  "postedWorkers",
  "templates",
  "migrationHistory"
