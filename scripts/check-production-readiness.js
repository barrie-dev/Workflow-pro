...
const shouldFail = openP0.length > 0 || (strictMode && openP1.length > 0);
...
console.log(strictMode
  ? "\nProduction preflight OK: geen P0 blockers of P1 warnings."
  : "\nProduction preflight OK: geen P0 blockers.");
