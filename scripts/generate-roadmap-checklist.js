...
function markdown(store, tenantId) {
  ...
  return [
    ...
    "Login, sessies, permissies en audit: zie de evidence-afgeleide status in docs/traceability/matrix.md (DEV-01), niet als statische claim.",
    "",
    ...
    "DPA/GDPR, support consent, invoice model en payment-tokenflow: dekking blijkt uit de gekoppelde tests in docs/traceability/matrix.md (DEV-01), niet als statische claim.",
    "",
    "## Fase 4 - Pilot Launch",
    "",
